Our prototype contract checker is called @halo@.
...
Consider this function @withMany@, from library @Foreign.Util.Marshal@:
...
viewed in Figure~\ref{fig:unsres}. Our full testsuite and tables can be downloaded from \url{http://www.cse.chalmers.se/~koen/halo}.
The test cases include:
\begin{itemize*}
  \item Crash-freedom of standard library functions, such as
    @(++)@, @iterate@, and @concatMap@.
...
Figure~\ref{fig:unsres}. This number ranges between 26-79 but does not appear to be 
